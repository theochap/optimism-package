...
VERBOSITY_LEVELS = {
    ethereum_package_constants.GLOBAL_LOG_LEVEL.error: "",
    ethereum_package_constants.GLOBAL_LOG_LEVEL.info: "v",
    ethereum_package_constants.GLOBAL_LOG_LEVEL.trace: "vv",
}
